        ...
        <div class="col-xl">
            <div class="card m-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5>Add mission form</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('missionsection.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-6">
                                ...
                                <div class="mb-6">
                                    <div class="form-group">
                                        <label for="form-label" class="form-label">Button One Text <span
                                                class="text-danger">*</span></label>
                                        <input type="text" value="" name="button_one_text"
                                ...
                                <div class="mb-6">
                                    <div class="form-group">
                                        <label for="form-label" class="form-label">Button One Url <span
                                                class="text-danger">*</span></label>
                                        <input type="text" value="" name="button_one_url"
                                ...
                                <div class="mb-6">
                                    <div class="form-group">
                                        <label for="form-label" class="form-label">Button Two Text <span
                                                class="text-danger">*</span></label>
                                        <input type="text" value="" name="button_two_text"
                                            class="form-control py-3 input_color" placeholder="Enter button Two text">
                                ...
                                <div class="mb-6">
                                    <div class="form-group">
                                        <label for="form-label" class="form-label">Button Two Url <span
                                                class="text-danger">*</span></label>
                                        <input type="text" value="" name="button_two_url"
