...
@section('main-content')
    <div class="card m-3">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5>District List</h5>
            <h5><a class="btn btn-primary waves-effect waves-light" href="{{ route('district.create') }}"> Add New </a></h5>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <a class="btn btn-primary" href="{{ route('district.edit', $singlevalue->id) }}"><i
                                            class="ti ti-pencil me-2"></i> Edit</a>
                                    <a class="btn btn-danger" href="{{ route('district.delete', $singlevalue->id) }}"
