                            ...
                            <div class="col-md-12">
                                <div class="mb-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="{{ $data['id'] }}" name="id" class="form-control py-3 input_color" placeholder="Enter Name">
                                ...
                                <div class="mb-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $data['button_text'] }}" name="button_text" class="form-control py-3 input_color" placeholder="Enter button one text">
                                    </div>
                                </div>
                                <div class="mb-6">
                                    <div class="form-group">
                                        <label for="form-label" class="form-label">Button  Url  <span class="text-danger">*</span></label>
                                        <input type="text" value="{{ $data['button_url'] }}" name="button_url" class="form-control py-3 input_color" placeholder="Enter button one url">
                                    </div>
                                </div>
