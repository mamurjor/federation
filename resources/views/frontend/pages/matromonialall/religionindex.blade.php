        ...
        <div class="table-responsive text-nowrap">
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    @foreach ($matromonialreligion as $index => $singlevalue)
                        <tr>
                            <td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <a class="btn btn-primary" href="{{ route('matromonialreligion.edit', $singlevalue->id) }}"><i
                                            class="ti ti-pencil me-2"></i> Edit</a>
                                    <a class="btn btn-danger" href="{{ route('matromonialreligion.delete', $singlevalue->id) }}"
