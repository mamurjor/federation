        ...
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><a href="{{ route('matromonialmarital.index') }}"> List </a></h5>

                </div>
                <div class="card-body">
                    <form action="{{ route('matromonialmarital.update') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="{{ $matromonialmarital->id }}" name="id"
                                            class="form-control py-3 input_color" placeholder="Enter Name">
                                        <input type="text" value="{{ $matromonialmarital->name }}" name="name"
                                            class="form-control py-3 input_color" placeholder="Enter Name">
                                            @error('name')
                                ...
                                <div class="mb-6">
                                    <div class="form-group">
                                        <label for="form-label" class="form-label">Code <span
                                                class="text-danger">*</span></label>
                                        <input type="text" value="{{ $matromonialmarital->code }}" name="code"
