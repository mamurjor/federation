                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="breadcrumd_heading text-center">
                            <h2 class="fw-bold">Single Matrimonial</h2>
                            <span><a href="#" class="text-black">Home </a> / <a href="#"
                                    class="text-black">Matrimonial </a> / single Matrimonial</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row justify-content-between">
                    <div class="col-md-12 col-lg-12 col-xl-12">
                            ...
                            <div class="col-md-12 col-sm-12 col-lg-7 col-xl-8">
                                <div class="common_single_bg bg-white py-5 px-5 rounded">
                                    <div class="single_add_heading">
                                        <h3 class="fw-bold mb-2">Basic Information</h3>
                                    </div>
                        ...
                        <div class="common_single_bg bg-white py-5 px-5 rounded mt-5">
                            <div class="single_add_heading">
                                <h3 class="fw-bold mb-2">Employment/Business Status Description:</h3>
                            </div>
                            <div class="single_add_heading border-0 mt-4">
                        ...
                        <div class="common_single_bg bg-white py-5 px-5 rounded mt-5">
                            <div class="single_add_heading">
                                <h3 class="fw-bold mb-2">Partner Preferences:</h3>
                            </div>
                            <div class="single_add_box mt-5">
                                <div class="single_add_heading border-0 mt-4">
                                    <p class="mb-2">{!! $matromonialsingle->partner_requirment_text !!}</p><br>
