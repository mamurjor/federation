...
@section('main-content')
    <div class="card m-3">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <h5><a class="btn btn-primary waves-effect waves-light" href="{{ route('blogcategories.create') }}"> Add New </a>
                </h5>
            </div>
        ...
        <div class="table-responsive text-nowrap">
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    @foreach ($blogcategory as $index => $singlevalue)
                        <tr>
                            <td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <a class="btn btn-primary" href="{{ route('blogcategories.edit', $singlevalue->id) }}"><i
                                            class="ti ti-pencil me-2"></i> Edit</a>
                                    <a class="btn btn-danger" href="{{ route('blogcategories.delete', $singlevalue->id) }}"
