            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="breadcrumd_heading text-center">
                        ...
                        <span><a href="#" class="text-black">Home </a> / <a href="#" class="text-black">Ads </a> / Single Ads</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-between">
                <div class="col-md-12 col-lg-8 col-xl-9">
                   <div class="common_single_bg bg-white py-5 px-5 rounded">
                        <img src="./img/single_ads_page/image1.png" id="mainCarosel">
                        <div id="thumbnailscarosel">
                        <img src="./img/single_ads_page/image1.png">
                        <img src="./img/single_ads_page/image2.png">
                        <img src="./img/single_ads_page/image3.png">
                        <img src="./img/single_ads_page/image4.png">
                        <img src="./img/single_ads_page/image5.png">
                        </div>
                   </div>
                   ...
                   <div class="common_single_bg bg-white py-5 px-5 rounded mt-5">
                        ...
                        <div class="single_add_box mt-5">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="single_add_box1 py-4 px-3 border rounded mb-3">
                                        <h6>Price: <span class="ms-3">${{ $classifiedsingle->price }} Negotiable</span></h6>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="single_add_box1 py-4 px-3 border rounded mb-3">
                ...
                <div class="col-md-12 col-lg-4 col-xl-3">
                    ...
                    <div class="card position-relative border-0 mb-3">
                        <h6 class="classified_position_heading  classified_position_heading_color position-absolute">Featured</h6>
                        ...
                        <div class="card-body">
                            <div class="card_date d-flex justify-content-between">
                                <div class="card_date_common mb-4 mobile_bg"><i class="fa-solid fa-laptop me-2 text-white"></i>Laptop</div>
