...
@section('main-content')
    <div class="card">
        <div class="d-flex justify-between">
            <h5 class="card-header"> <a href="{{ route('votepositiontype.create') }}"> Add New </a> </h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <a class="btn btn-primary" href="{{ route('votepositiontype.edit', $singlevalue->id) }}"><i
                                            class="ti ti-pencil me-2"></i> Edit</a>
                                    <a class="btn btn-danger" href="{{ route('votepositiontype.delete', $singlevalue->id) }}"
