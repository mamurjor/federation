...
@section('main-content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5>District Vote announce List</h5>
            <h5><a class="btn btn-success waves-effect waves-light" href="{{ route('disvoteannounce.create') }}"> Add New </a>
            </h5>
        </div>
        <div class="table-responsive text-nowrap">
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    @foreach ($disvoteannounce as $index => $singlevalue)
                        <tr>
                            <td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <a class="btn btn-primary"
                                        href="{{ route('disvoteannounce.edit', $singlevalue->id) }}"><i
                                            class="ti ti-pencil me-2"></i> Edit</a>
                                    <a class="btn btn-danger" href="{{ route('disvoteannounce.delete', $singlevalue->id) }}"
    ...
    <div class="card mt-5">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <h5><a class="btn btn-warning waves-effect waves-light" href="{{ route('wingsvoteannounce.create') }}"> Add New
                </a>
            </h5>
        </div>
        <div class="table-responsive text-nowrap">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <a class="btn btn-primary"
                                        href="{{ route('wingsvoteannounce.edit', $singlevalue->id) }}"><i
                                            class="ti ti-pencil me-2"></i> Edit</a>
                                    <a class="btn btn-danger"
                                        href="{{ route('wingsvoteannounce.delete', $singlevalue->id) }}"
                                        onclick="return confirm('Are Your Suere')"> Delete</a>
