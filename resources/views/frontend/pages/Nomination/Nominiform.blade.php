                            ...
                            <div class="col-md-12">
                                <div class="mb-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly value="{{ $voteannouncement->votetype }}"
                                ...
                                <div class="mb-6">
                                    <div class="form-group">
                                        <label for="form-label" class="form-label"><span class="text-danger">*</span>
                                            District </label>
                                        <input type="text" readonly value="{{ $voteannouncement->district }}"
                                ...
                                <div class="mb-6">
                                    <div class="form-group">
                                        <label for="form-label" class="form-label"><span class="text-danger">*</span>Tehsil
                                        </label>
                                        <input type="text" readonly value="{{ $voteannouncement->tehsil }}"
                                            name="tehsil" class="form-control py-3 input_color"
                                            placeholder="Enter votetype">
                                ...
                                <div class="mb-6">
                                    <div class="form-group">
                                        <label for="form-label" class="form-label"><span class="text-danger">*</span>
                                            Announce </label>
                                        <input type="text" readonly value="{{ $voteannouncement->announce }}"
                                ...
                                <div class="mb-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly value="{{ $voteannouncement->votingdate }}"
